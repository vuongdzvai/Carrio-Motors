		...
		<?php
			if(isset($_GET['quanly'])=='capnhat'){
				...
				<form action="xulysanpham.php" method="POST" enctype="multipart/form-data">
					...
					<textarea class="form-control" rows="10" name="chitiet"><?php echo $row_capnhat['thuong_hieu'] ?></textarea><br>
			...
			<div class="col-md-8">
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><?php echo number_format($row_sp['dong_co']).'vnđ' ?></td>
						<td><?php echo number_format($row_sp['mau_xe']).'vnđ' ?></td>
